...
public class Advancement {
	...
	public void award(Player player) {
		org.bukkit.advancement.Advancement bukkitAdvancement = Bukkit.getAdvancement(id);
		if (bukkitAdvancement != null) {
			AdvancementProgress progress = player.getAdvancementProgress(bukkitAdvancement);
