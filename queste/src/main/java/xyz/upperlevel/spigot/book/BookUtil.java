...
public final class BookUtil {
    ...
    private static final boolean CAN_TRANSLATE_DIRECTLY;
    ...
    static {
        ...
        CAN_TRANSLATE_DIRECTLY = success;
    }
    ...
    public static void openPlayer(Player p, ItemStack book) {
        ...
        //Opening the GUI
        NmsBookHelper.openBook(p, event.getBook());
    }
    ...
    public static class BookBuilder {
        ...
        /**
         * Creates a new instance of the BookBuilder with a blank book
         */
        public BookBuilder() {
    ...
    public interface HoverAction {
        ...
        static HoverAction showEntity(Entity entity) {
            return showEntity(entity.getUniqueId(), entity.getType().getKey().getNamespace(), entity.getName());
        }

        /**
         * Creates a show_achievement action: when the component is hovered the achievement information will be displayed
         * @param advancementId the id of the achievement to display
         * @return a new HoverAction instance
         */
        static HoverAction showAchievement(String advancementId) {
            return new SimpleHoverAction(HoverEvent.Action.SHOW_TEXT, new TextComponent("advancement." + advancementId));
        }

        /**
         * Creates a show_achievement action: when the component is hovered the achievement information will be displayed
         * @param advancement the achievement to display
         * @return a new HoverAction instance
         */
        static HoverAction showAchievement(Advancement advancement) {
            return showAchievement(advancement.getKey().getNamespace());
        }
        ...
        static HoverAction showStatistic(String statisticId) {
            return new SimpleHoverAction(HoverEvent.Action.SHOW_TEXT, new TextComponent("statistic." + statisticId));
        }
